...
class Settings:
    ...
    # ---- 四期：存储 ----
    # 默认 SQLite（零外部依赖，落在 DATA_DIR/maidui.db）。
...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        qdrant_collection=os.getenv("QDRANT_COLLECTION", "maidui_products"),
        reranker_base_url=os.getenv("RERANKER_BASE_URL", ""),
        reranker_model=os.getenv("RERANKER_MODEL", ""),
        tavily_api_key=os.getenv("TAVILY_API_KEY", ""),
        otlp_endpoint=os.getenv("OTEL_EXPORTER_OTLP_ENDPOINT", ""),
        data_dir=data_dir,
        category_kb_collection=os.getenv("CATEGORY_KB_COLLECTION", "maidui_category_kb"),
        ...
        database_url=(
            ...
            or f"sqlite+aiosqlite:///{data_dir / 'maidui.db'}"
        ),
